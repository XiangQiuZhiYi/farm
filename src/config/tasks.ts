...
const TASK_SEEDS: TaskSeed[] = [
  ...
  },
  {
    ...
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'water_celery', quantity: 36 }],
  },
  {
    id: 'task_easy_04',
    title: '荷塘鲜藕',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'lotus_root', quantity: 24 }],
  },
  {
    id: 'task_easy_05',
    title: '谷仓补货',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'rice', quantity: 24 }],
  },
  {
    id: 'task_easy_06',
    title: '水乡茭白单',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'water_bamboo', quantity: 30 }],
  },
  {
    id: 'task_easy_07',
    title: '荸荠集市',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'water_chestnut', quantity: 40 }],
  },
  {
    id: 'task_easy_08',
    title: '油坊油菜单',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'rapeseed', quantity: 24 }],
  },
  {
    id: 'task_easy_09',
    title: '豆铺蚕豆',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'broad_bean', quantity: 24 }],
  },
  {
    id: 'task_easy_10',
    title: '冬粮小麦',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'wheat', quantity: 24 }],
  },
  {
    id: 'task_easy_11',
    title: '菜铺甘蓝',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'cabbage', quantity: 30 }],
  },
  {
    id: 'task_easy_12',
    title: '脆萝卜急单',
    ...
    isTimed: true,
    timeLimitMonths: 2,
    requirements: [{ plantId: 'carrot', quantity: 36 }],
  },
  {
    id: 'task_easy_13',
    title: '蒜铺备货',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'garlic', quantity: 20 }],
  },
  {
    id: 'task_easy_14',
    title: '集市鲜玉米',
    difficulty: 'easy',
    isTimed: false,
    requirements: [{ plantId: 'corn', quantity: 24 }],
  },
